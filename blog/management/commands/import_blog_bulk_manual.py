...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for item in posts:
            ...
            self.stdout.write(self.style.NOTICE(f"FINAL: id={post.id} slug={post.slug} cover_image={getattr(post.cover_image, 'name', None)} created={created}"))from django.core.management.base import BaseCommand
from django.utils import timezone
from datetime import datetime
from django.utils.text import slugify
from blog.models import BlogPost
